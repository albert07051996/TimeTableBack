...
public partial class Prproject
{
    ...
    public string? HourBilling { get; set; }
    ...
    public bool UseNewPlanning { get; set; }

    public double CostBudget { get; set; }

    public bool UseDeliverablesWbs { get; set; }

    public byte InvoiceGrouping { get; set; }

    public Guid Sysguid { get; set; }

    public Guid? IdorderAccount { get; set; }

    public Guid? IdinvoiceAccount { get; set; }

    public Guid? IdorderContact { get; set; }

    public Guid? IddeliveryContact { get; set; }

    public Guid? IdinvoiceContact { get; set; }

    public bool AllowEntryForNonMembers { get; set; }
